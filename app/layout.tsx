...
export const metadata: Metadata = {
  ...
  title: {
    ...
    template: `%s | Physical Therapy`
  },
  description: 'Expert, hands-on physical therapy to help you recover from injury, manage pain, and return to the activities you love. Our licensed therapists create individual',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
